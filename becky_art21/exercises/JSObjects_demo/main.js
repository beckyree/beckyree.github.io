...
//   //change show.year to display year instead
//   yearDiv.innerHTML = show.epTwoTitle;
// }
// // loops through the teen dramas and runs the displayTDramas function for each one
// teenDramas.forEach(displayTDramas);
...
// //"mouseover" where "click" is for a diff effect
// showDiv.addEventListener("click", displayEpTitle);
